...
- **QUESTION #1**
    ...
    $[a\rarrow b]$는 하노이 탑 문제에서 $막대\;a$에서 $막대\;b$로 원반을 옮기는 '기본 이동'을 나타내며,
    기본 이동 여러 개를 더하여 '과정'을 만들 수 있다.
    
    예를 들어, $[1\rarrow 2]$와 $[1\rarrow 3]$는 각각 $막대\;1$에서 $막대\;2$로, $막대\;1$에서 $막대\;3$으로 원반을 옮기는 기본 이동을 나타내며, 아래와 같이 이 둘을 더하여 새로운 과정을 만들 수 있다.
    ...
    $$
    [1\rarrow 2,\;1\rarrow3]+[2\rarrow3]=[1\rarrow 2,\;1\rarrow3,\;2\rarrow3]
    $$
    
    한편 $p(n, a\rarrow b)$은 하노이 탑 문제에서 $n$개의 원반을 $막대\;a$에서 $막대\;b$로 옮기는 과정이다.
    
    예를 들어, $p(3, 1\rarrow 3)$은 $3$개의 원반을 $막대\;1$에서 $막대\;2$으로 옮기는 과정이며,
    아래와 같이 나타낸다:
    
    $$
    p(3, 1\rarrow3)=[1\rarrow3,\;1\rarrow2,\;3\rarrow2,\;1\rarrow3,\;2\rarrow1,\;2\rarrow3,\;1\rarrow3]
    $$
    
    $p(n, a\rarrow b)$를 구하는 일반적인 방법을 설명하시오.
